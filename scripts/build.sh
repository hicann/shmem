...
function fn_gen_doc()
{
    ...
    sed -i "s#EXPAND_AS_DEFINED      =.*#EXPAND_AS_DEFINED      = ACLSHMEM_TYPE_FUNC ACLSHMEM_TYPENAME_P_AICORE ACLSHMEM_TYPENAME_G_AICORE ACLSHMEM_GET_TYPENAME_MEM ACLSHMEM_GET_TYPENAME_MEM_TENSOR ACLSHMEM_PUT_TYPENAME_MEM ACLSHMEM_PUT_TYPENAME_MEM_TENSOR ACLSHMEM_GET_TYPENAME_MEM_TENSOR_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_TENSOR_DETAILED#g" $doxyfile
    sed -i "s#EXCLUDE_SYMBOLS        =.*#EXCLUDE_SYMBOLS        = ACLSHMEM_GLOBAL ACLSHMEM_TYPENAME_P_AICORE ACLSHMEM_TYPENAME_G_AICORE ACLSHMEM_GET_TYPENAME_MEM ACLSHMEM_GET_TYPENAME_MEM_TENSOR ACLSHMEM_PUT_TYPENAME_MEM ACLSHMEM_PUT_TYPENAME_MEM_TENSOR ACLSHMEM_GET_TYPENAME_MEM_DETAILED ACLSHMEM_GET_TYPENAME_MEM_TENSOR_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_TENSOR_DETAILED DcciCacheline addrGm#g" $doxyfile

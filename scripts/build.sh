...
function fn_gen_doc()
{
    ...
    sed -i "s#^ENABLE_PREPROCESSING  =.*#ENABLE_PREPROCESSING   = YES#g" $doxyfile
    ...
    sed -i "s#EXPAND_AS_DEFINED      =.*#EXPAND_AS_DEFINED      = ACLSHMEM_TYPE_FUNC ACLSHMEM_TYPE_FUNC_ATOMIC_INT ACLSHMEM_TYPE_FUNC_ATOMIC_FLOAT ACLSHMEM_ATOMIC_ADD_TYPENAME_FLOAT ACLSHMEM_ATOMIC_ADD_TYPENAME ACLSHMEM_TEST_TYPE_FUNC ACLSHMEM_TEST ACLSHMEM_TYPENAME_P_AICORE ACLSHMEM_TYPENAME_G_AICORE ACLSHMEM_GET_TYPENAME_MEM ACLSHMEM_GET_TYPENAME_MEM_NBI ACLSHMEM_GET_TYPENAME_MEM_TENSOR_NBI ACLSHMEM_GET_TYPENAME_MEM_TENSOR_DETAILED_NBI ACLSHMEM_PUT_TYPENAME_MEM ACLSHMEM_PUT_TYPENAME_MEM_NBI ACLSHMEM_PUT_TYPENAME_MEM_TENSOR_NBI ACLSHMEM_PUT_TYPENAME_MEM_TENSOR_DETAILED_NBI ACLSHMEM_PUT_TYPENAME_MEM_SIGNAL ACLSHMEM_PUT_TYPENAME_MEM_SIGNAL_TENSOR ACLSHMEM_PUT_TYPENAME_MEM_SIGNAL_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_SIGNAL_NBI ACLSHMEM_PUT_TYPENAME_MEM_SIGNAL_TENSOR_NBI ACLSHMEM_PUT_TYPENAME_MEM_SIGNAL_DETAILED_NBI ACLSHMEM_TYPE_PUT ACLSHMEM_TYPE_PUT_NBI ACLSHMEM_TYPE_GET ACLSHMEM_TYPE_GET_NBI ACLSHMEM_TYPENAME_P ACLSHMEM_TYPENAME_G ACLSHMEM_TEST#g" "$doxyfile"
    sed -i "s#EXCLUDE_SYMBOLS        =.*#EXCLUDE_SYMBOLS        = shmem* ACLSHMEM_TEST ACLSHMEM_GET_TYPENAME_* ACLSHMEM_ATOMIC_* ACLSHMEM_TYPE_GET* ACLSHMEM_TYPE_PUT* ACLSHMEM_TYPENAME_* ACLSHMEM_PUT_TYPENAME_* ACLSHMEM_GLOBAL ACLSHMEM_TYPENAME_P_AICORE ACLSHMEM_TYPENAME_G_AICORE ACLSHMEM_GET_TYPENAME_MEM ACLSHMEM_GET_TYPENAME_MEM_TENSOR ACLSHMEM_PUT_TYPENAME_MEM ACLSHMEM_PUT_TYPENAME_MEM_TENSOR ACLSHMEM_GET_TYPENAME_MEM_DETAILED ACLSHMEM_GET_TYPENAME_MEM_TENSOR_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_DETAILED ACLSHMEM_PUT_TYPENAME_MEM_TENSOR_DETAILED DcciCacheline addrGm#g" "$doxyfile"

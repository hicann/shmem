...
| --- | --- | --- | --- | --- | --- |
| Ascend HDK 26.0.RC1 | 9.1.0 及以上<br>[CANN 资源](https://www.hiascend.com/developer/download/community/result?module=cann&cann=9.1.0) | MTE<br>RDMA<br>SDMA<br>UDMA（仅支持 Ascend950） | MTE<br>SDMA（仅支持 A3） | MTE<br>SDMA（仅支持 A3） | 使能 UDMA 需安装 Ascend950 对应的 toolkit 包和 ops 包 |

...
#ifndef CATCOC_COMM_EPILOGUE_BLOCK_EPILOGUE_TO_LOCAL_MEM_H
#define CATCOC_COMM_EPILOGUE_BLOCK_EPILOGUE_TO_LOCAL_MEM_H
...
#endif // CATCOC_COMM_EPILOGUE_BLOCK_EPILOGUE_TO_LOCAL_MEM_H
...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_FIXPIPE_H
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_FIXPIPE_H
...
>
struct BlockMmad <
    MmadAtlasA2PreloadFixpipeQuant<ENABLE_UNIT_FLAG_, ENABLE_SHUFFLE_K_>,
    L1TileShape_,
    L0TileShape_,
    AType_,
    BType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlasA2PreloadFixpipeQuant<ENABLE_UNIT_FLAG_, ENABLE_SHUFFLE_K_>;
    ...
    using CopyL0CToGm = Gemm::Tile::CopyL0CToGm<ArchTag, ElementAccumulator, CType_,
        ...
        bool isFirstBlock, bool hasNextBlock)
    {
        ...
        AscendC::WaitFlag<AscendC::HardEvent::FIX_MTE2>(0);
        copyGmToL1S(l1STensor, gmBlockS, layoutTileS, layoutScale);
...
#endif // CATLASS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_FIXPIPE_HPP

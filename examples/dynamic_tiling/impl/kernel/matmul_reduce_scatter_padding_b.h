 ...
 */
#ifndef MATMUL_REDUCE_SCATTER_PADDING_B_KERNEL_H
#define MATMUL_REDUCE_SCATTER_PADDING_B_KERNEL_H
...
>
CATLASS_DEVICE
void MatmulReduceScatterPaddingBImpl(
...
>
CATLASS_DEVICE
void MatmulReduceScatterPaddingBImpl_M0_256(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
>
CATLASS_DEVICE
void MatmulReduceScatterPaddingBImpl_M0_128(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
>
CATLASS_GLOBAL
void MatmulReduceScatterPaddingB(
...
)
{
    ...
    if (m0 == 128) {
        MatmulReduceScatterPaddingBImpl_M0_128<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD>(
            problemShape, l1TileShape,
            gmA, layoutA, gmB, layoutB, gmD, layoutD,
            gmWA, gmWB,
            rank, rankSize, commInterval,
        ...
        MatmulReduceScatterPaddingBImpl_M0_256<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD>(
            problemShape, l1TileShape,
            gmA, layoutA, gmB, layoutB, gmD, layoutD,
            gmWA, gmWB,
            rank, rankSize, commInterval,
...
#endif // MATMUL_REDUCE_SCATTER_PADDING_B_KERNEL_H
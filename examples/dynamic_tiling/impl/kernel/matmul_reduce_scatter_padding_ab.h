 ...
 */
#ifndef MATMUL_REDUCE_SCATTER_PADDING_AB_KERNEL_H
#define MATMUL_REDUCE_SCATTER_PADDING_AB_KERNEL_H
...
>
CATLASS_DEVICE
void MatmulReduceScatterPaddingABImpl(
...
>
CATLASS_DEVICE
void MatmulReduceScatterPaddingABImpl_M0_256(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
>
CATLASS_DEVICE
void MatmulReduceScatterPaddingABImpl_M0_128(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
>
CATLASS_GLOBAL
void MatmulReduceScatterPaddingAB(
...
)
{
    ...
    if (m0 == 128) {
        MatmulReduceScatterPaddingABImpl_M0_128<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD>(
            problemShape, l1TileShape,
            gmA, layoutA, gmB, layoutB, gmD, layoutD,
            gmWA, gmWB,
            rank, rankSize, commInterval,
        ...
        MatmulReduceScatterPaddingABImpl_M0_256<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD>(
            problemShape, l1TileShape,
            gmA, layoutA, gmB, layoutB, gmD, layoutD,
            gmWA, gmWB,
            rank, rankSize, commInterval,
...
#endif // MATMUL_REDUCE_SCATTER_PADDING_AB_KERNEL_H
...
#include "gm2gm/aclshmemi_device_rma.h"
...
{
    int ret = aclshmemi_prepare_and_post_rma("aclshmem putmem", ACLSHMEMI_OP_PUT, NO_NBI, (uint8_t *)dst, (uint8_t *)src,
...
{
    int ret = aclshmemi_prepare_and_post_rma("aclshmem getmem", ACLSHMEMI_OP_GET, NO_NBI, (uint8_t *)dst, (uint8_t *)src,
                                          elem_size, 1, pe, nullptr, 0, 0, 1, 1, g_state_host.default_stream,
                                          g_state_host.default_block_num);
    if (ret < 0) {

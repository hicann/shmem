...
constexpr uint64_t EXPORT_INFO_VERSION = 0x3UL;
...
struct MemSegmentOptions {
    ...
    uint32_t flags = 0;
    const UserBufferHeapInput* userBufferHeapInput = nullptr;
    int32_t* trustedPids = nullptr;
    uint32_t trustedPidCount = 0;
};

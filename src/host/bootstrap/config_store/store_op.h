...
public:
     ...
     */
    int32_t Set(const std::string &key, const std::string &value) noexcept;
     ...
     * @return 0 if successfully done
     */
    int32_t Get(const std::string &key, std::string &value, int64_t timeoutMs = -1) noexcept;
     ...
     * @return 0 if successfully done
     */
    int32_t Get(const std::string &key, std::vector<uint8_t> &value, int64_t timeoutMs = -1) noexcept;
     ...
     * @return 0 if successfully done
     */
    virtual int32_t Set(const std::string &key, const std::vector<uint8_t> &value) noexcept = 0;
     ...
     * @return 0 if successfully done
     */
    virtual int32_t Add(const std::string &key, int64_t increment, int64_t &value) noexcept = 0;
     ...
     * @return 0 if successfully done
     */
    int32_t Remove(const std::string &key) noexcept;
     ...
     * @return 0 if successfully done
     */
    virtual int32_t Remove(const std::string &key, bool printKeyNotExist) noexcept = 0;
     ...
     * @return 0 if successfully done
     */
    int32_t Append(const std::string &key, const std::string &value, uint64_t &newSize) noexcept;
     ...
     * @return 0 if successfully done
     */
    virtual int32_t Append(const std::string &key, const std::vector<uint8_t> &value, uint64_t &newSize) noexcept = 0;
     ...
     */
    int32_t Cas(const std::string &key, const std::string &expect, const std::string &value,
     ...
     *         <i>exists</i> and <i>expect</i>.
     */
    virtual int32_t Cas(const std::string &key, const std::vector<uint8_t> &expect, const std::vector<uint8_t> &value,
     ...
     * @return 0 if successfully done
     */
    int32_t Watch(const std::string &key,
                 const std::function<void(int int32_t, const std::string &, const std::string &)> &notify,
     ...
     * @return 0 if successfully done
     */
    virtual int32_t Watch(
        const std::string &key,
        const std::function<void(int int32_t, const std::string &, const std::vector<uint8_t> &)> &notify,
     ...
     * @return 0 if successfully done
     */
    virtual int32_t Unwatch(uint32_t wid) noexcept = 0;
...
protected:
    virtual int32_t GetReal(const std::string &key, std::vector<uint8_t> &value, int64_t timeoutMs) noexcept = 0;
    static constexpr uint32_t MAX_KEY_LEN_CLIENT = 1024U;
};
using StorePtr = SmRef<ConfigStore>;

inline int32_t ConfigStore::Set(const std::string &key, const std::string &value) noexcept
{
    return Set(key, std::vector<uint8_t>(value.begin(), value.end()));
}

inline int32_t ConfigStore::Get(const std::string &key, std::string &value, int64_t timeoutMs) noexcept
{
...
inline int32_t ConfigStore::Get(const std::string &key, std::vector<uint8_t> &value, int64_t timeoutMs) noexcept
{
    return GetReal(key, value, timeoutMs);
}

inline int32_t ConfigStore::Remove(const std::string &key) noexcept
{
    return Remove(key, false);
}

inline int32_t ConfigStore::Append(const std::string &key, const std::string &value, uint64_t &newSize) noexcept
{
    std::vector<uint8_t> u8val(value.begin(), value.end());
    return Append(key, u8val, newSize);
}

inline int32_t ConfigStore::Cas(const std::string &key, const std::string &expect, const std::string &value,
                               std::string &exists) noexcept
{
...
inline int32_t ConfigStore::Watch(
    const std::string &key, const std::function<void(int int32_t, const std::string &, const std::string &)> &notify,
    uint32_t &wid) noexcept
{
    return Watch(
        key,

...
SHMEM_HOST_API int32_t shmem_get_uniqueid(shmemx_uniqueid_t *uid);

SHMEM_HOST_API int shmemx_set_attr_uniqueid_args(const int my_rank, const int n_ranks, const int64_t local_mem_size,

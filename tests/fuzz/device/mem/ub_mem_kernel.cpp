    ...
    public:                                                                                                          \
        ...
        {                                                                                                            \
            ...
            aclshmem_put_##NAME##_mem_nbi(dst_gm[local_size * 2], buf_tensor[local_size * 2], local_size,               \
                                       (rank + 1) % rank_size);                                                      \
            aclshmem_put_##NAME##_mem_nbi(gva_gm + local_size * 3, buf + local_size * 3, local_size,                    \
                                       (rank + 1) % rank_size);                                                      \
                                                                                                                     \
...
ACLSHMEM_FUNC_TYPE_KERNEL(KERNEL_UB_PUT_NUM);
...
ACLSHMEM_FUNC_TYPE_KERNEL(UB_PUT_NUM_TEST);
...
ACLSHMEM_FUNC_TYPE_KERNEL(TEST_UB_PUT);
    ...
    public:                                                                                            \
        ...
        {                                                                                              \
            ...
            aclshmem_get_##NAME##_mem_nbi(buf + local_size * 2, gva_gm + local_size * 2, local_size,      \
                                       (rank + 1) % rank_size);                                        \
            aclshmem_get_##NAME##_mem_nbi(buf_tensor[local_size * 3], src_gm[local_size * 3], local_size, \
                                       (rank + 1) % rank_size);                                        \
                                                                                                       \
...
ACLSHMEM_FUNC_TYPE_KERNEL(KERNEL_UB_GET_NUM);
...
ACLSHMEM_FUNC_TYPE_KERNEL(UB_GET_NUM_TEST);
...
ACLSHMEM_FUNC_TYPE_KERNEL(TEST_UB_GET);

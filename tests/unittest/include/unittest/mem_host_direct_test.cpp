...
#define PUT_MEM_TEST(NAME, TYPE)                                                                                   \
    ...
    public:                                                                                                        \
        ...
        {                                                                                                          \
            if (is_nbi) {                                                                                          \
                aclshmem_put_##NAME##_mem_nbi(gva_gm, dev_gm, rank_size * 16, rank);                                  \
            } else {                                                                                               \
                aclshmem_put_##NAME##_mem(gva_gm, dev_gm, rank_size * 16, rank);                                      \
            }                                                                                                      \
        }                                                                                                          \
                                                                                                                   \
    private:                                                                                                       \
...
ACLSHMEM_MEM_PUT_GET_FUNC(PUT_MEM_TEST)
        ...
        {                                                                                                          \
            if (is_nbi) {                                                                                          \
                for (int i = 0; i < rank_size; i++) {                                                              \
                    aclshmem_get_##NAME##_mem_nbi(dev_gm + 16 * i, gva_gm, 16, i % rank_size);                        \
                }                                                                                                  \
            } else {                                                                                               \
                for (int i = 0; i < rank_size; i++) {                                                              \
                    aclshmem_get_##NAME##_mem(dev_gm + 16 * i, gva_gm, 16, i % rank_size);                            \
                }                                                                                                  \
            }                                                                                                      \
        }                                                                                                          \
                                                                                                                   \
...
ACLSHMEM_MEM_PUT_GET_FUNC(GET_MEM_TEST)
